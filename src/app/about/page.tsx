        ...
        <div className={styles.timelineContainer}>
          <div className={styles.timelineSection}>
            <div className={styles.textBlock}>
              ...
              <p className={styles.subtitle}>
                Spring 2025 marked a defining milestone for Cornell AutoBoat.
                Building on our design and testing from the fall, the team
                competed at RoboBoat and earned an international fifth place
                finish! This achievement reflected significant improvements
                across all subteams. Beyond competition results, this season
                demonstrated the team’s progress, and setting a strong
          ...
          <div className={`${styles.timelineSection} ${styles.reverse}`}>
            <div className={styles.textBlock2}>
              ...
              <p className={styles.subtitle}>
                ...
                for our new boat Scooby. This semester emphasized extensive
                on-water testing, sensor calibration, and refinement of our
                ROS-based autonomy, including improved perception pipelines,
                navigation logic, and GPS/IMU integration. Electrical,
                mechanical, and robotics updates focused on new design decisions
                for Scooby. The insights gained from testing on Clifford and the
                addition of new competition tasks guided our improvements
          ...
          <div className={styles.timelineSection}>
            <div className={styles.textBlock}>
              ...
              <p className={styles.subtitle}>
                ...
                geometry, and an upgraded electrical system.
              </p>
            </div>
            <div className={styles.imageContainer}>
              <Image
