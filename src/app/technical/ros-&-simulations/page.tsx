    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.techSection}>
        ...
        <p className={styles.descr}>
          ...
          simulation mocks perception and controls code so that the AI team can
          test path planning code in isolation. It includes a generic map of the
        ...
        <p className={styles.descr}>
          ...
          refine the codebase to be cross-compatible with both ROS and ROS2. We
          also anticipate building upon the simulations, perhaps incorporating
