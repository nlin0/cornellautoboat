...
function getSubteamDescription(team: string): string {
  ...
  return descriptions[team] || 'Part of the Cornell AutoBoat crew';
}
      ...
      <div className={styles.teamIntro}>
        <div className={styles.teamIntroContent}>
          <div className={styles.teamIntroText}>
            <h2 className={styles.teamIntroTitle}>
              Meet our Team!
            </h2>
            <p className={styles.teamIntroDescription}>
          ...
          <ul className={styles.teamIntroBand} role="list">
            <TeamStat icon={<Flag size={32} aria-hidden="true" />} label="Founded in 2021" />
            <TeamStat icon={<Users size={32} aria-hidden="true" />} label="60+ members" />
            <TeamStat icon={<GraduationCap size={32} aria-hidden="true" />} label="14 different majors" />
            <TeamStat icon={<School size={32} aria-hidden="true" />} label="3 different Cornell colleges" />
            <TeamStat icon={<Globe size={32} aria-hidden="true" />} label="6 different home countries" />
          </ul>
        </div>
      </div>
            ...
            <div key={subteam.team} className={`${styles.subTeamSection} ${styles[`subTeamSection${index + 1}`]}`}>
              <div className={styles.terminalHeader}>
                <div className={styles.gateInfo}>
                  ...
                  <div className={styles.gateDestination}>
                    ...
                    <span className={styles.destinationName}>{subteam.team}</span>
                  </div>
                </div>
              ...
              <div className={styles.terminalContent}>
                ...
                <div className={styles.boardingArea}>
                  <div className={styles.boardingLabel}>BOARDING PASSES</div>
