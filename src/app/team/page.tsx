...
function getSubteamDescription(team: string): string {
  const descriptions: Record<string, string> = {
    ...
    'Business and Outreach': 'The Business subteam and brings together students from a wide range of backgrounds. They manage the team\'s funding for supplies, apparel, and software licensing, and serves as the team\'s public-facing arm. Web Dev designs, builds, and maintains the team\'s website, ensuring an accessible digital presence. Outreach organizes events with local schools and organizations to link our team with the Ithaca community. Design focuses on creating graphics and branding. Media produces digital content via videos, photos, and written articles to document the team\'s work, highlight events, and share our story with a broader audience.',
  };
