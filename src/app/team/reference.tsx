        ...
        <section className="bg-[#e3dbda] py-16 px-4 text-white">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8 justify-items-center">
              {/* Lead Card 1 */}
              <div className="bg-[#706b6b] w-full max-w-[350px] rounded-t-3xl overflow-hidden shadow-lg rounded-b-3xl border-4 border-[#363738]">
                <div className="bg-[#706b6b] w-full max-w-[350px] rounded-t-3xl overflow-hidden shadow-lg rounded-b-3xl">
                  <img
                    src="Neha.png"
                    alt="Name"
